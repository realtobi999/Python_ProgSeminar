...
- **Ukázkové odpovědi:**
  ...
  12. Jedná se o oblast informatiky zaměřenou na vývoj strojů nebo systémů, které dokážou vykonávat úkoly obvykle vyžadující lidskou inteligenci. Hlavním cílem umělé inteligence (AI) je napodobit fungování lidského mozku, což by umožnilo systémům samostatně jednat, přemýšlet a vykonávat práci bez lidského zásahu.
